    ...
    describe('N/N', () => {
      ...
      describe('Party 1', () => {
        it('Generate Shared Keys', () => {
          const [err, p1SharedKeys] = TurtleCoinCrypto.generateNN(
          ...
          const [err1, publicViewKey] = TurtleCoinCrypto.secretKeyToPublicKey(p1SharedKeys.secretViewKey)
          assert(!err1)
      ...
      describe('Party 2', () => {
        it('Generate Shared Keys', () => {
          const [err, p2SharedKeys] = TurtleCoinCrypto.generateNN(
            party2.spend.publicKey,
            party2.view.secretKey,
            [party1.spend.publicKey],
            [party1.view.secretKey]
          ...
          const [err1, publicViewKey] = TurtleCoinCrypto.secretKeyToPublicKey(p2SharedKeys.secretViewKey)
          assert(!err1)
          assert(publicViewKey === sharedKeys.view.publicKey)
        })
      })
